...
import tour6 from "../assets/images/tour/bangkok.jpg";
import tour7 from "../assets/images/tour/cancun.jpg";
import tour8 from "../assets/images/tour/nah-trang.jpg";
import tour9 from "../assets/images/tour/cancun.jpg";
          ...
          <Row>
            <Col md="12">
              <div className="main_heading">
                <h1> Explore the Top Destinations for Your Next Escape </h1>
              </div>
            </Col>
          </Row>
      ...
      <section className="call_us">
        <Container>
          <Row className="align-items-center">
            <Col md="8">
              <h5 className="title">Book Your Dream Trip Today</h5>
              <h2 className="heading">
              Planning an Unforgettable Trip? We're Here for You!
              </h2>
              <p className="text">
